...
//     .sourceMaps();
// mix.sass('resources/scss/styles.scss', 'public/assets/css/default/app.min.css');
mix.postCss('resources/css/style.css', 'public/assets/css');
mix.copy('resources/images/','public/assets/img')
