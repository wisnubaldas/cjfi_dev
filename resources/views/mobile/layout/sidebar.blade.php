<ul id="slide-nav" class="sidenav sidemenu">
    ...
    <img src="/mobile/images/office.jpg">
  </div> -->
            <div class="col s3 imgarea">
                <a href="#user"><img class="circle" src="/mobile/images/user-37.jpg"></a></div>
            <div class="col s9 infoarea">
                <a href="#name"><span class="name">Chang Jui Fang Indonesia</span></a>
                <span class="">Creamic Manufacturer, Importer and Distributor</span>
            </div>
        </div>
    </li>
            ...
            <li class="lvl1 ">
                <div class=" waves-effect ">
                    <a href="sub-apps.html">
                        ...
                        <span class="title">APPS</span><span
                            class="badge blue-grey lighten-3 badge-rounded">NEW</span>
                    </a>
                </div>
            </li>
            <li class="lvl1 ">
            ...
            <li class="lvl1 ">
                <div class=" waves-effect ">
                    <a href="sub-charts.html">
                        ...
                        <span class="title">Charts</span><span
                            class="badge blue-grey lighten-3 badge-rounded">HOT</span>
                    </a>
                </div>
            </li>
            <li class="lvl1 ">
