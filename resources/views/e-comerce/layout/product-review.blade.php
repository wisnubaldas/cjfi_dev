        ...
        <div class="col-md-7 mb-4 mb-lg-0">
            ...
            <div class="review">
                <div class="review-info">
                    <div class="review-icon"><img src="../src/img/user/user-1.jpg" alt="" />
                    </div>
            ...
            <div class="review">
                <div class="review-info">
                    <div class="review-icon"><img src="../src/img/user/user-2.jpg" alt="" />
                    </div>
                    <div class="review-rate">
                        <ul class="review-star">
                            <li class="active"><i class="fa fa-star"></i></li>
            ...
            <div class="review">
                <div class="review-info">
                    <div class="review-icon"><img src="../src/img/user/user-3.jpg" alt="" />
                    </div>
                    <div class="review-rate">
                        <ul class="review-star">
                            <li class="active"><i class="fa fa-star"></i></li>
                ...
                <div class="review-message">
                    ...
                    nec ultrices tellus. Mauris elementum venenatis volutpat.
                </div>
            </div>
            <!-- END review -->
            <!-- BEGIN review -->
            <div class="review">
                <div class="review-info">
                    <div class="review-icon"><img src="../src/img/user/user-4.jpg" alt="" />
                    </div>
                    <div class="review-rate">
                        <ul class="review-star">
                            <li class="active"><i class="fa fa-star"></i></li>
            ...
            <div class="review">
                <div class="review-info">
                    <div class="review-icon"><img src="../src/img/user/user-5.jpg" alt="" />
                    </div>
                    <div class="review-rate">
                        <ul class="review-star">
                            <li class="active"><i class="fa fa-star"></i></li>
                ...
                <div class="review-message">
                    ...
                    Cras mattis turpis quis eros volutpat tristique vel a ligula. Proin aliquet
                    leo mi, et euismod metus placerat sit amet.
                </div>
            </div>
            <!-- END review -->
        </div>
